...
export default function Projects () {
    return <section id="work">
		<h2 className="p-2">
			Check out my web pages and projects
		</h2>
		<div className="pages mx-auto">
			...
			<ProjectFrame 
				...
				title={'Tiny Ecology'}
				description={'This is the professional page of Dr. Stephanie Jurburg, powered by Angular.'}
			/>
			<ProjectFrame 
				image={expore}
			...
			<ProjectFrame 
				...
				description={'Here you can find notes from our Fullstack intensive training as well \
			...
			<ProjectFrame 
				...
				description={'Calculator of the Bangwa week day from the gregorian calendar.'}
			/>
			<ProjectFrame 
				image={backToTheBurger}
				link={'https://dcihackathon.herokuapp.com/#/menu'} 
				title={'Back to the Burger'}
				description={'Mock up of a restaurant page with online ordering. This page was made \
			...
			<ProjectFrame 
				...
				title={'Movie App'}
				description={'Initially made in React this Movie Application was then converted \
